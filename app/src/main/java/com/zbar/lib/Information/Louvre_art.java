...
public class Louvre_art extends Activity {

    private static final String URL = "http://en.wikipedia.org/wiki/Louvre";
    ...
    private class FetchWebsiteData extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mProgressDialog = new ProgressDialog(Louvre_art.this);
