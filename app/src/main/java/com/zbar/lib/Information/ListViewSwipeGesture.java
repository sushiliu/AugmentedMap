...
public class ListViewSwipeGesture implements OnTouchListener {
    ...
    // private List<TouchCallbacks> mSwipeListeners = new ArrayList<TouchCallbacks>();

    // public void addListener(TouchCallbacks Callbacks)
    //{
    //  mSwipeListeners.add(Callbacks);
    // }
    ...
    private void SetBackGroundforList() {
        ...
        mDownView_parent_txt1.setTextColor(Color.BLACK);
        ...
        if (SwipeType == Double) {
            ...
            mDownView_parent_txt2.setTextColor(Color.BLACK);
